...
PROJECT_REPO ?= github.com/freelaunch/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-mongodbatlas_v1.8.2_x5
...
xpkg.build.provider-mongodb: do.build.images
